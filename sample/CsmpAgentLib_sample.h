...
/** \brief max number of address per interface */
...
Interface_Desc g_interfaceDesc[MAX_INTERFACES] = {INTERFACE_DESC_INIT};

/** \brief the ipaddress information */
IP_Address g_ipAddress[MAX_IP_ADDRESSES] = {IPADDRESS_INIT};
